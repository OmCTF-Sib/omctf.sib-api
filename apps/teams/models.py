...
class Team(models.Model):
    ...
    second_fio = models.CharField('ФИО Участника', max_length=255)
    third_fio = models.CharField('ФИО Участника', max_length=255)
    fourth_fio = models.CharField('ФИО Участника', max_length=255)
